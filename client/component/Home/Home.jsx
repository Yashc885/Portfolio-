...
function Home() {
  ...
  return (
    <section className="pl-10 pr-10 relative flex flex-col items-center justify-between py-4 lg:py-12">
      <Image
        src={Main}
        alt="Hero"
        width={1572}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-12 gap-y-8 items-start">
        <div className="flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10 order-2 lg:order-1">
          <h1 
            data-aos="fade-up" 
          ...
          >
            Hello, <br />
            This is {' '}
            <span className="text-pink-500">{personal.name}</span>
            {` , I'm a  `}
        ...
        <div 
            ...
            data-aos-duration="2000" 
            data-aos-delay="500" 
            className="order-1 lg:order-2 bg-gradient-to-r from-[#0a0d37] to-[#0d1224] border-[#1b2c68a0] border rounded-lg relative">
          ...
          <div
            ...
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              <div>
                ...
                <span className="text-gray-400">{`'`}</span>
                <span className="text-amber-300">Yash Choudhary</span>
                <span className="text-gray-400">{`',`}</span>
              </div>
              ...
              <div>
                <span className="ml-4 lg:ml-8 mr-2 text-white">TeamLeader:</span>
                <span className="text-orange-400">true</span>
                <span className="text-gray-400">,</span>
              </div>
              <div>
